import type { CentroidMap } from "@/lib/geo-filter";

const STATE_CENTROIDS: CentroidMap = {
...
const CITY_CENTROIDS: CentroidMap = {
...
export const FALLBACK_CENTROIDS: CentroidMap = {
  ...STATE_CENTROIDS,
  ...CITY_CENTROIDS,
};
